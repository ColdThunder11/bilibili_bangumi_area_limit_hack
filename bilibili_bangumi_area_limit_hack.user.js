        ...
        */
        ...
        function requestByXhr(url) {
            return new Promise$1((resolve, reject) => {
                ...
                req.setRequestHeader("x-from-biliroaming", "pc");
                req.setRequestHeader("x-form-coldthunder11", "Do not widely use my personal server");
        ...
        function requestByJQuery(url) {
            const creator = () => new Promise$1((resolve, reject) => {
                let options = { url: url };
                options.headers = {
                    "x-from-biliroaming": "pc",
                    "x-form-coldthunder11": "Do not widely use my personal server"
                };
